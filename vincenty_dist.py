...
class vincenty(object):
    ...
    def problema_inverso(self, phi1, lamb1, phi2, lamb2, elip, dms=True):
        """
    ...
    def problema_direto(self, phi1, lamb1, alpha1, s, elip, dms=True):
        """
        @parâmetros: phi1 - latitude do ponto 1
        ...
        """
        if dms == True:
            phi1, lamb1, alpha1 = dms2degrees(
                phi1), dms2degrees(lamb1), dms2degrees(alpha1)
